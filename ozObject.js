...
// object.status
document.querySelector('.status').textContent = object.status;

// object.result
for( const result of object.result){
document.querySelector(`#result${result.answerId}`).textContent = result.count;
document.querySelector(`#percent${result.answerId}`).textContent = result.percent;
}

// object.question
document.querySelector('.questoin').textContent = object.question;

// object.image
// document.querySelector('img').src = object.image;

// object.category
document.querySelector('.category').textContent = object.category;

// object.answers
for( const answer of object.answers)
document.querySelector(`#answer${answer.id}`).textContent = answer.text;
